...
class ArticleWordGraphUntangle extends React.Component<Props, State> {
    ...
    private toggleLoading(isLoading = false, _hasRealData = false) {
        const id = `#${this.sid()}`;
        d3.select(id).classed('hidden', isLoading);
        d3.select(`${id}-loader`).classed('hidden', !isLoading);
    }
...
export default ArticleWordGraphUntangle;
